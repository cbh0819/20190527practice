 ...
 * @param  number   chips
 */
Player.sitOnTable = function( tableId, seat, chips ) {
 ...
 */
Player.prepareForNewRound = function() {
    this.cards = [];
    this.public.cards = [];
    this.public.hasCards = false;
    this.public.bet = 0;
 ...
 */
Player.evaluateHand = function( board ) {
