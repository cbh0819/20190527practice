...
// The function that emits the events of the table
Table.emitEvent = function( eventName, eventData ){
 ...
 * @return number|null
 */
Table.findNextPlayer = function( offset, status ) {
 ...
 * @return number|null
 */
Table.findPreviousPlayer = function( offset, status ) {
    offset = typeof offset !== 'undefined' ? offset : this.public.activeSeat;
    status = typeof status !== 'undefined' ? status : 'inHand';
 ...
 */
Table.initializeRound = function( changeDealer ) {
 ...
 */
Table.initializeSmallBlind = function() {
 ...
 * Method that starts the "small blind" round
 */
Table.initializeBigBlind = function() {
 ...
 */
Table.initializePreflop = function() {
 ...
 */
Table.initializeNextPhase = function() {
 ...
 */
Table.actionToNextPlayer = function() {
 ...
 * @param int seat
 */
Table.playerPostedSmallBlind = function() {
 ...
 * @param int seat
 */
Table.playerPostedBigBlind = function() {
 ...
 * When a player bets
 */
Table.playerBetted = function( amount ) {
 ...
 */
Table.playerRaised = function( amount ) {
 ...
 * @param int 		seat
 */
Table.playerSatOnTheTable = function( player, seat, chips ) {
 ...
 * @param int seat
 */
Table.playerSatIn = function( seat ) {
    this.log({
 ...
 * @param int seat
 */
Table.playerLeft = function( seat ) {
    this.log({
 ...
 */
Table.playerSatOut = function( seat, playerLeft ) {
...
Table.otherPlayersAreAllIn = function() {
 ...
 */
Table.removeAllCardsFromPlay = function() {
    // For each seat
    for( var i=0 ; i<this.public.seatsCount ; i++ ) {
        // If a player is sitting on the current seat
        if( this.seats[i] !== null ) {
