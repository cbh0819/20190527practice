 ...
 */
Pot.addTableBets = function( players ) {
 ...
 */
Pot.addPlayersBets = function( player ) {
    // Getting the current pot (the one in which new bets should be added)
    var currentPot = this.pots.length-1;
...
Pot.destributeToWinners = function( players, firstPlayerToAct ) {
 ...
 * @param object  winner
 */
Pot.giveToWinner = function( winner ) {
    var potsCount = this.pots.length;
    var totalAmount = 0;
 ...
 * @param  number   seat
 */
Pot.removePlayer = function( seat ) {
    var potsCount = this.pots.length;
